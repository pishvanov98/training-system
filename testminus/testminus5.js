        ...
        var out='';
          out +='<div class="tests_result">';
            ...
            out +='<div class="border_result">';
             ...
             out +=`<p class="not_correct_answer">${data.not_correct3_answer5}</p><div id="result1none"></div>`;
                out +=`<p class="correct_answer">${data.correct_answer5}</p><div id="result2none"></div>`;
                out +=`<p id="not_correct_answer1">${data.not_correct_answer5}</p><div id="result3none"></div>`;
                out +=`<p id="not_correct2_answer1">${data.not_correct2_answer5}</p><div id="result4none"></div>`;
            out +='</div>';
            out +='</div>';
        out +='</div>';
        out +=`<p class="correct_answer_result">ПРАВИЛЬНЫЙ<br>ОТВЕТ - ${data.correct_answer5}</p>`;
